...
// compliance status, deficiencies, expiring certificates, PSC risk. On this
// page — public, indexed, no product chrome around it — a real PIL name may
// never carry any of that. If you add a real vessel to this array, that breaks.
// (The demo at /demo is held to a different rule; see the README.)
